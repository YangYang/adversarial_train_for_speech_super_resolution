...
class GeneratorNet(nn.Module):
    def __init__(self):
        ...
        "encoder layers"
        # conv1
        self.conv1 = nn.Conv1d(in_channels=129, out_channels=256, kernel_size=7, stride=2, padding=3)
        ...
        "upsample layer"
        self.conv8 = nn.Conv1d(in_channels=512, out_channels=141 * 2, kernel_size=7, stride=1, padding=3)
        self.bn8 = nn.BatchNorm1d(num_features=141)
        self.LeakyReLU8 = nn.LeakyReLU(negative_slope=0.2)
        "output layer"
        self.conv9 = nn.Conv1d(in_channels=141, out_channels=141, kernel_size=9, stride=1, padding=4)
...
class DiscriminatorNet(nn.Module):
    def __init__(self):
        ...
        self.conv1 = SNConv2d(in_channels=270, out_channels=512, kernel_size=(7, 1), stride=2, padding=(3, 0))
